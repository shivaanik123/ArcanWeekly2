...
def render_move_schedule(unit_availability_data: Dict[str, Any], total_units: int, current_occupied: int):
    ...
    # Generate table rows with proper metric structure (like other tables)
    table_rows = """
    ...
    for i, metric_text in enumerate(metrics_data):
        ...
        <div class="metric-row">
            ...
            <span class="metric-value">{schedule_data[i]['Move Ins']}↑ {schedule_data[i]['Move Outs']}↓ {schedule_data[i]['Units']} ({schedule_data[i]['Occupancy']})</span>
        </div>
        """
    ...
    st.markdown("""
        <div class="schedule-legend">
            <div class="legend-item">
                <span class="legend-symbol">↑</span> Move Ins
            </div>
            <div class="legend-item">
                <span class="legend-symbol">↓</span> Move Outs
            </div>
        </div>
